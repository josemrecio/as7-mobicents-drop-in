...
//            mime.get(DESCRIPTION).set(bundle.getString("sip.configuration.mime-mapping"));
...
//            mime.get(type, Constants.NAME, DESCRIPTION).set(bundle.getString("sip.configuration.mime-mapping.name"));
...
//            mime.get(type, Constants.VALUE, DESCRIPTION).set(bundle.getString("sip.configuration.mime-mapping.value"));
...
//        node.get(type, Constants.WELCOME_FILE, DESCRIPTION).set(bundle.getString("sip.configuration.welcome-file"));
...
//        node.get(type, Constants.LISTINGS, DESCRIPTION).set(bundle.getString("sip.configuration.static.listings"));
...
//        node.get(type, Constants.SENDFILE, DESCRIPTION).set(bundle.getString("sip.configuration.static.sendfile"));
...
//        node.get(type, Constants.FILE_ENCODING, DESCRIPTION).set(bundle.getString("sip.configuration.static.file-encoding"));
//        node.get(type, Constants.FILE_ENCODING, REQUIRED).set(false);
//
//        node.get(type, Constants.READ_ONLY, TYPE).set(ModelType.BOOLEAN);
//        node.get(type, Constants.READ_ONLY, DESCRIPTION).set(bundle.getString("sip.configuration.static.read-only"));
...
//        node.get(type, Constants.WEBDAV, DESCRIPTION).set(bundle.getString("sip.configuration.static.webdav"));
...
//        node.get(type, Constants.SECRET, DESCRIPTION).set(bundle.getString("sip.configuration.static.secret"));
//        node.get(type, Constants.SECRET, REQUIRED).set(false);
//
//        node.get(type, Constants.MAX_DEPTH, TYPE).set(ModelType.INT);
//        node.get(type, Constants.MAX_DEPTH, DESCRIPTION).set(bundle.getString("sip.configuration.static.max-depth"));
...
//        node.get(type, Constants.DISABLED, DESCRIPTION).set(bundle.getString("sip.configuration.static.disabled"));
